...
//         />
//         <div
//           className={`absolute inset-0 flex flex-col justify-center items-center px-10 text-white
//     transition-opacity duration-700 ease-in-out
//     ${isActive ? "opacity-100 visible" : "opacity-0 invisible"}
//   `}
//         >
//           <p
//             className="relative font-bold uppercase tracking-[var(--letterSpacing-2)]
//                text-[var(--gold-crayola)] mb-3
//                after:content-[var(--separator)] after:block after:w-[100px]
//                after:mx-auto after:mt-[5px]"
//             style={{ "--separator": `url(${separator})` }}
//           >
//             {slide.subtitle}
//           </p>
...
//           <p className="transition-opacity duration-700 delay-100 mb-6">
//             {slide.text}
//           </p>
//           <Button href="#menu" text="View Our Menu" />
//         </div>
//       </div>
//     </>
//   );
